                ...
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <form action="signup.php" class="flex flex-col items-center justify-center" method="post">
                        ...
                        <div class="flex flex-col items-start justify-center w-full">
                            ...
                            <input type="text" name="fullname" id="fullname" class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-400" placeholder="fullname">
                        </div>
                        <div class="flex flex-col items-start justify-center w-full">
                        ...
                        <div class="flex flex-col items-start justify-center w-full">
                            ...
                            <input type="password" name="password2" id="password2" class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-400" placeholder="Password">
                        </div>
