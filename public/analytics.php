            ...
            <div class="w-10/12 h-[calc(100vh-3.5rem)] p-2">
                ...
                <div class="w-full h-auto border-2 border-gray-200 rounded-md py-4 px-6">
                    ...
                    <div class="flex items-center gap-2 mb-3 justify-between">
                        <div>
                            <a href="analytics.php" class="text-gray-700 hover:text-gray-950"><i class="fas fa-home"></i></a>
                    ...
                    <div class="flex flex-col gap-4 mt-4">
                        <div class="flex flex-row justify-between items-center">
                            ...
                            <div class="flex flex-row gap-2 mt-4">
                                <a class="flex flex-row justify-center items-center bg-gray-200 hover:bg-gray-300 rounded-md px-4 py-2 text-gray-700 space-x-2" href="analytics.php?reload=true&reloadcluster=true">
                                    <i class="fas fa-sync-alt"></i>
                                    <span>Reload Cluster</span>
                                </a>
                                <a class="flex flex-row justify-center items-center bg-gray-200 hover:bg-gray-300 rounded-md px-4 py-2 text-gray-700 space-x-2" href="analytics.php?reload=true&reloadtrend=true">
                                    <i class="fas fa-sync-alt"></i>
                            ...
                            if ($toogleBtnAnalyticsCounter == 0) {
                                ...
                                if ($reload) {
                                    if ($reloadcluster) {
                                        ...
                                        // print_r($totalData);
                                        // print_r($randomSales);
                                        // print_r($beetweenClassVariation);
                                        // print_r($totalWithinClassVariation);
                                        // print_r($rasio);
                                        // echo "</pre>";
                                    }
                                    if ($reloadtrend == 'true') {
                                        ...
                                        if ($result_sales_cluster->num_rows == 0) {
                                            // reloadcluster = true
                                            header("Location: analytics.php?reload=true&reloadcluster=true&reloadtrend=true");
                                        } else {
