...
<div class="w-2/12 h-[calc(100vh-3.5rem)] border-r-2 border-gray-200 overflow-y-auto overflow-hidden no-scrollbar">
    <div class="flex flex-col items-center justify-center mt-4  p-2 space-y-2">
        ...
        <img src="<?php if ($_SESSION["photo"] == "") {
                        echo "img/profile/profile.jpeg";
                    } else {
                        echo "img/profile/" . $_SESSION["photo"];
    ...
    <div class="p-2">
        ...
        <ul class="space-y-2">
            ...
            ?>
                <hr class="border-gray-200">
                <li class="flex flex-row justify-between items-center space-x-2 hover:bg-fuchsia-200 rounded-md p-2 cursor-pointer" onclick="toggleDropdown('5')">
                    <div class="flex flex-row items-center">
            ...
            ?>
            <hr class="border-gray-200">
            <li class="flex flex-row justify-between items-center space-x-2 hover:bg-fuchsia-200 rounded-md p-2 cursor-pointer" onclick="toggleDropdown('2')">
                <div class="flex flex-row items-center">
                ...
                <!-- dropdown menu -->
                <div>
                    <i class="fas fa-chevron-down first-letter:text-gray-500 ml-auto rotate-180" id="dropdown-icon-2"></i>
                </div>
            </li>
            ...
            <hr class="border-gray-200">
            <li class="flex flex-row justify-between items-center space-x-2 hover:bg-fuchsia-200 rounded-md p-2 cursor-pointer" onclick="toggleDropdown('3')">
                <div class="flex flex-row items-center">
                ...
                <!-- dropdown menu -->
                <div>
                    <i class="fas fa-chevron-down first-letter:text-gray-500 ml-auto rotate-180" id="dropdown-icon-3"></i>
                </div>
            </li>
            <!-- dropdown menu list with icons and text -->
            <ul id="dropdown-menu-3" class="flex-col space-y-2 pl-4 py-2 hidden">
                ...
                <li class="flex flex-row justify-between items-center space-x-2 hover:bg-fuchsia-200 rounded-md p-2 cursor-pointer">
                    <div>
                        ...
                        <a href="sales_per_month.php?page=1&year=" class="text-gray-700 hover:text-gray-900">Sales Per Month</a>
                    </div>
                </li>
            </ul>
            <hr class="border-gray-200">
            <li class="flex flex-row justify-between items-center space-x-2 hover:bg-fuchsia-200 rounded-md p-2 cursor-pointer" onclick="toggleDropdown('4')">
                <div class="flex flex-row items-center">
                ...
                <!-- dropdown menu -->
                <div>
                    <i class="fas fa-chevron-down first-letter:text-gray-500 ml-auto rotate-180" id="dropdown-icon-4"></i>
                </div>
            </li>
            <!-- dropdown menu list with icons and text -->
            <ul id="dropdown-menu-4" class="flex-col space-y-2 pl-4 py-2 hidden">
                ...
                <li class="flex flex-row justify-between items-center space-x-2 hover:bg-fuchsia-200 rounded-md p-2 cursor-pointer">
                    <div class="flex flex-row items-center">
                        <i class="fa-solid fa-chart-bar text-fuchsia-500 text-lg mr-2"></i>
                        <a href="analytics_result.php" class="text-gray-700 hover:text-gray-900">Analytics Result</a>
                    </div>
                </li>
            </ul>
            <!-- Sign out -->
